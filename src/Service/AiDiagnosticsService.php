            ...
            $response = $client->post(
                ...
                (string)json_encode([
                    ...
                    'messages' => [
                        [
                            'role' => 'system',
                            'content' => 'You are an SRE assistant. Analyse the provided system metrics and alerts, '
                                . 'then give a concise operational diagnosis in plain English (max 3 sentences).',
                        ],
                        [
                            'role' => 'user',
                            'content' => $prompt,
